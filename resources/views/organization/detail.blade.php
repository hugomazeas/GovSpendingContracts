...
<body>
    <div class="main-container">
        ...
        <div class="header-section">
            ...
            <p>Detailed spending analysis and contract breakdown</p>
        </div>
                ...
                <div class="section-card">
                    ...
                    <div class="vendor-item">
                        ...
                        <div class="item-info">
                            ...
                            <div class="item-details">{{ number_format($vendor->contract_count) }} contracts</div>
                        </div>
            ...
            <div class="col-lg-6 mb-4">
                <div class="section-card">
                    ...
                    <div class="year-item">
                        ...
                        <div class="item-info">
                            <div class="item-name">{{ number_format($year->contract_count) }} contracts</div>
                            <div class="item-details">Average: ${{ number_format($year->total_spending / $year->contract_count, 0) }}</div>
                        </div>
                        <div class="item-metric">
        ...
        <div class="section-card">
            ...
            <div class="contract-item">
                ...
                <div class="item-metric">
                    ...
                    <div class="metric-secondary">contract value</div>
                </div>
            </div>
            @endforeach
        </div>
